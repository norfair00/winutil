...
$inputXML = (new-object Net.WebClient).DownloadString("https://raw.githubusercontent.com/norfair00/winutil/$BranchToUse/MainWindow.xaml") #uncomment for Production
...
(
    ...
    $configs["$psitem"] = Invoke-RestMethod "https://raw.githubusercontent.com/norfair00/winutil/$BranchToUse/config/$psitem.json"
}
...
$WPFinstall.Add_Click({
        ...
        if (Test-Path ~\AppData\Local\Microsoft\WindowsApps\winget.exe) {
            ...
            if (((($OSName.IndexOf("LTSC")) -ne -1) -or ($OSName.IndexOf("Server") -ne -1)) -and (($ComputerInfo.WindowsVersion) -ge "1809")) {
                ...
                Start-Process powershell.exe -Verb RunAs -ArgumentList "-command irm https://raw.githubusercontent.com/norfair00/winutil/$BranchToUse/winget.ps1 | iex | Out-Host" -WindowStyle Normal
...
$WPFtweaksbutton.Add_Click({
        ...
        If ( $WPFEssTweaksRemoveEdge.IsChecked -eq $true ) {
            ...
            Invoke-WebRequest -useb https://raw.githubusercontent.com/norfair00/winutil/$BranchToUse/Edge_Removal.bat | Invoke-Expression
